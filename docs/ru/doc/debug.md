...
> Перевод `doc/debug.md` (blob `bfe6a95cf7aaae4bc1ff5ab1174f8db385a46294`).
...
всё, что такому скоупу есть сказать, — и до появления этой отчётности он не
говорил ничего: его жизненный цикл был виден только отладчику.
...
- **у семейства без собственной фазы та же пара требует того `onInit`,
  ...
  всё ещё способны закрыть разбор, открывшийся вовсе без `onInit`.
