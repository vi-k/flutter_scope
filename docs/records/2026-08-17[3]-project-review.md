...
блок «обещания документации». Все восемь дартдоков теперь называют оба условия
...
**Вердикт: исправлено.** Волна 14, тем же блоком. Оба комментария переведены;
...
**Вердикт: исправлено.** Волна 14, тем же блоком: `AsyncScope.of(context,
listen: true).state`, в оригинале и в зеркале.
