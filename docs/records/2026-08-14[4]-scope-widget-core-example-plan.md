...
> **Состояние на 2026-08-14:** выполнено прямо в `main` (`a8a8472`); красный
> widget-тест подтвердил отсутствие example, итоговый тест — 1/1, полный гейт
> прошёл, публикуемый архив имеет 0 предупреждений.
...
- [x] **Шаг 1: написать падающий widget-тест**
...
- [x] **Шаг 2: подтвердить красный прогон**
...
- [x] **Шаг 3: реализовать минимальный example**
...
- [x] **Шаг 4: подтвердить зелёный прогон example**
...
- [x] **Шаг 5: встроить второй блок во вкладку**
...
- [x] **Шаг 6: обновить README и зеркало**
...
- [x] **Шаг 7: закрыть только выполненный пункт бэклога**
...
- [x] **Шаг 8: отформатировать только новые и изменённые Dart-файлы**
...
- [x] **Шаг 9: прогнать проверки до коммита результата**
...
- [x] **Шаг 10: проверить и закоммитить результат**
...
- [x] **Шаг 11: проверить публикуемый архив после коммита**
...
- [x] **Шаг 1: обновить шапки design и plan**
