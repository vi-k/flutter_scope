...
> **Состояние на 2026-08-28:** сделано целиком и смержено в `main`, `18b73eb`;
> CI зелёная. Дизайн выполнен без расхождений. Объём вышел шире исходной
> заявки: владелец решил закрыть обе половины жизненного цикла контейнера и
> заодно развести `onProgress` — хуков стало двенадцать вместо девяти, и релиз
> стал **ломающим**. Тестов 424 → 435, гейт §6 пройден целиком.
