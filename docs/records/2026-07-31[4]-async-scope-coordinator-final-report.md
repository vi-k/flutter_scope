...
> **Состояние на 2026-08-12:** замечания закрыты, редизайн смержен в `main` (12b4c9f); часть найденного здесь довели уже после мержа — см. `2026-08-01-cross-review-fixes.md`. Исторический документ, не поддерживается.
