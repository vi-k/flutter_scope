...
> **Состояние на 2026-08-12:** замечания закрыты, редизайн смержен в `main` (12b4c9f); часть найденного здесь довели уже после мержа — см. `2026-08-01[1]-cross-review-fixes.md`. Исторический документ, не поддерживается.
> **Что это:** отчёт предмержевого ревью редизайна координации.
> **Связанные записи:** план — `2026-07-31[2]-async-scope-coordinator-plan.md`, задачи — `2026-07-31[3]-async-scope-coordinator-tasks.md`.
