...
> **Состояние на 2026-08-15:** реализовано в `45aa808`; исходный P1 №2 закрыт.
> Оба упомянутых здесь review шли по ветке `onPop == null` — единственной, что
> покрыта тестами; третье, независимое, нашло на ветке `onPop` две регрессии
> волны. См. `2026-08-15[9]-navigation-system-back-audit-report.md`.
