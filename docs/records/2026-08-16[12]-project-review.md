...
> №3, №11, №19. **Каждая закрытая находка кончается абзацем «Вердикт»**; текст
> самой находки исторический и не правится, даже там, где проверка показала,
> что находка была неточна.
