...
> **Состояние на 2026-08-24: выполнен, кроме раскладки — она пересмотрена по
> ходу.** Все восемь шагов пройдены, но вариант A′ (второй пакет в этом же
> репозитории) оказался невозможен: `dart pub publish` ставит начало обхода
> ignore-файлов в корень git-репозитория, поэтому вложенный пакет не может
> одновременно не ехать в архиве соседа и публиковаться сам. Владелец выбрал
> отдельный репозиторий; сделанное переехало туда как есть. Итог и обе пробы —
> в `2026-08-24[3]-navigation-node-extraction-report.md`.
> **Что это:** порядок работ по U7 и четыре решения владельца, на которых он
> стоит; три из четырёх в силе (имя пакета, самостоятельный пример, версия
> 0.11.0), пересмотрена только раскладка.
> **Связанные записи:** `2026-08-24[1]-navigation-node-boundary-design.md`
> (измерение и цена трёх вариантов), `2026-08-24[3]-…-report.md` (отчёт),
> `2026-08-23[1]-consumer-review.md` (находка U7).
