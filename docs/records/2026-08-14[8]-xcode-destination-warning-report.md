...
> **Состояние на 2026-08-14:** расследование закончено и зафиксировано в
> `b9b0694`, дефекта в scopo нет, код пакета и демо не менялся. Warning признан
> косметикой Flutter 3.29.0 на современном Xcode; пункт удалён из бэклога.
