...
> **Состояние на 2026-08-18:** аудит проведён, владелец прошёл по всем двадцати
> находкам и дал решение по каждой. Задание на правки — в
> `2026-08-18[2]-naming-plan.md`; раздел «Что я предлагаю взять» ниже им
> отменён. Вердикты придут сюда по мере выполнения волн.
