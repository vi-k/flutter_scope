...
> **Состояние на 2026-08-16:** реализовано и смержено в `main`: `68be486`
> (переименование), `ff2df2f` (семейство), `e2005d7` (демо). Два места
> дизайна оказались точнее в реальности, чем на бумаге, — см. отчёт
