...
> **Состояние на 2026-08-14:** выполнено и закоммичено в `main` (`ef0843a`),
> полный гейт зелёный. Первый publish dry-run дал предупреждение о
> незакоммиченном `doc/c_scope_model.md`, повторный после коммита — 0
> предупреждений.
...
- [x] **Шаг 1: добавить английский абзац после примера**
...
- [x] **Шаг 2: добавить точный русский перевод**
...
- [x] **Шаг 3: обновить штамп и проверить зеркало**
...
- [x] **Шаг 4: удалить выполненную запись из бэклога**
...
- [x] **Шаг 5: прогнать полный гейт**
  ...
  dry-run публикации без предупреждений; все 13 переводов актуальны. Если
  publish dry-run предупреждает только о незакоммиченном публикуемом
  `doc/c_scope_model.md`, закоммитить результат на следующем шаге и повторить
  эту проверку: валидатор требует чистого состояния самого архива.

- [x] **Шаг 6: проверить и закоммитить пользовательский результат**
  ...
  После коммита повторить `fvm dart pub publish --dry-run`. Ожидание: 0
  предупреждений.
...
- [x] **Шаг 1: обновить исторические шапки**
...
- [x] **Шаг 3: проверить и закоммитить состояние**
