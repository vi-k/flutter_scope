...
> **Состояние на 2026-08-14:** план готов; реализация не начата.
...
- [ ] **Шаг 1: подтвердить чистую исходную точку example**
...
- [ ] **Шаг 2: объяснить `ScopeWidgetBase` и `ScopeWidgetCore`**
...
- [ ] **Шаг 3: объяснить три варианта `ScopeModel`**
...
- [ ] **Шаг 4: объяснить три варианта `ScopeNotifier` и special-сценарий**
...
- [ ] **Шаг 5: отформатировать синхронные файлы без известного исключения**
...
- [ ] **Шаг 6: проверить блок и только комментарийный diff**
...
- [ ] **Шаг 7: записать частичный результат и закоммитить блок**
...
- [ ] **Шаг 1: объяснить общую матрицу пересоздания**
...
- [ ] **Шаг 2: объяснить element-owned жизненный цикл `AsyncScopeCore`**
...
- [ ] **Шаг 3: объяснить готовое значение и прогресс `AsyncDataScopeBase`**
...
- [ ] **Шаг 4: форматирование, локальная проверка и коммит**
...
- [ ] **Шаг 1: объяснить матрицу трёх сценариев в обоих семействах**
...
- [ ] **Шаг 2: объяснить жизненный цикл `LiteScopeState`**
...
- [ ] **Шаг 3: объяснить три части полного `Scope`**
...
- [ ] **Шаг 1: объяснить границу `NavigationNode`**
...
- [ ] **Шаг 2: объяснить отложенное закрытие и screenshot-replacement**
...
- [ ] **Шаг 3: локально проверить последние семь файлов**
...
- [ ] **Шаг 4: закрыть бэклог и подготовить handoff перед длинной проверкой**
...
- [ ] **Шаг 5: прогнать все семь обязательных проверок**
...
- [ ] **Шаг 6: зафиксировать результаты и закоммитить завершение реализации**
...
- [ ] **Шаг 1: обновить шапки и отметить выполненные шаги**
...
- [ ] **Шаг 2: сделать `handoff` снимком завершённой работы**
...
- [ ] **Шаг 3: проверить и закоммитить исторический итог**
